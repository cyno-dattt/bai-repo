...
<section class="products">
   ...
   <h3 class="heading">Danh sách mong muốn của bạn</h3>
   ...
   <?php
      ...
      echo '<p class="empty">Danh sách mong muốn của bạn đang trống</p>';
   }
   ?>
   </div>
   ...
   <div class="wishlist-total">
      ...
      <a href="wishlist.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>" onclick="return confirm('delete all from wishlist?');">Xóa tất cả các mục</a>
   </div>
