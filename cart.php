...
<section class="products shopping-cart">
   ...
   <form action="" method="post" class="box">
      ...
      <div class="sub-total">Tổng tiền : <span>$<?= $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/-</span> </div>
      <input type="submit" value="Xóa sản phẩm" onclick="return confirm('Xóa khỏi giở hàng?');" class="delete-btn" name="delete">
   </form>
   <?php
   ...
   <div class="cart-total">
      ...
      <a href="cart.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>" onclick="return confirm('Xóa tất cả khỏi giở hàng?');">Xóa tất cả các mục</a>
